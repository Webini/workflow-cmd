...
const buildDocument = require('workflow-worker/src/services/buildWorkflowDocument.js');
const makeWorkflow = require('workflow-worker/src/workflow/workflow.js');
const Ignore = require('workflow-worker/src/workflow/commands/ignore.js');
